...
class EntityVoidCreeper(world: World) : EntityCreeper(world) {
    ...
    override fun writeEntityToNBT(tag: NBTTagCompound) {
        ...
        tag.setBoolean("ignited", this.hasIgnited())
    }
    ...
    private fun creeperGoBoom() {
        if (!this.worldObj.isRemote) {
            ...
            var potential = this.worldObj.getEntitiesWithinAABB(EntityLivingBase::class.java, AxisAlignedBB.fromBounds(this.posX - r, this.posY - r, this.posZ - r, this.posX + r, this.posY + r, this.posZ + r))
