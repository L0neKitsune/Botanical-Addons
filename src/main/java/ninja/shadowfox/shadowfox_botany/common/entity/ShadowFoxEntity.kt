...
public object ShadowFoxEntity {
    ...
    init {
        ...
        EntityRegistry.registerModEntity(EntityThrownItem::class.java, "shadowfox_botany:thrownItem", EntityRegistry.findGlobalUniqueEntityId(), ShadowfoxBotany, 64, 10, true)
