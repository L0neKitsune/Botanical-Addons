...
@Deprecated("1.7.10")
class ItemWireAxe()
//val name: String = "axeRevelation", val toolMaterial: Item.ToolMaterial = ShadowFoxAPI.RUNEAXE, val slayerDamage: Double = 6.0): ItemSword(toolMaterial)
//        , IManaUsingItem {
//
//    companion object {
...
//    }
//
//    override fun getDigSpeed(itemstack: ItemStack, state: IBlockState): Float  =
//            if (ForgeHooks.isToolEffective(Minecraft().theWorld, block, meta) ||
//                    state.block.material == Material.wood ||
//                    state.block.material == Material.plants ||
//                    state.block.material == Material.vine ||
//                    state.block.material == Material.coral ||
//                    state.block.material == Material.leaves ||
//                    state.block.material == Material.gourd)
//                this.getEfficiencyOnProperMaterial()
//            else if (state.block == Blocks.web)
//                15f
//            else
//                1f
//
