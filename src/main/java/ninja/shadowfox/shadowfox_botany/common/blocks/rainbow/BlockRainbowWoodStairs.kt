...
@Deprecated("1.7.10")
open class BlockRainbowWoodStairs()
//source: Block = ShadowFoxBlocks.rainbowPlanks) : BlockStairsMod(source, 0, source.unlocalizedName.replace("tile.".toRegex(), "") + "Stairs"), ILexiconable {
//    init {
//    }
//
