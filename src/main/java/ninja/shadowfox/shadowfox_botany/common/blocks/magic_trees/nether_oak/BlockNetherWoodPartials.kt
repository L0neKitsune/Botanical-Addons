...
@Deprecated("1.7.10")
class BlockNetherWoodSlab()
//full: Boolean, source: Block = ShadowFoxBlocks.netherPlanks) : BlockRainbowWoodSlab(full, source) {
...
@Deprecated("1.7.10")
class BlockNetherWoodStairs()
//source: Block = ShadowFoxBlocks.netherPlanks) : BlockRainbowWoodStairs(source) {
//    override fun register() {
