...
@Deprecated("1.7.10")
class BlockSealingWoodSlab()
//full: Boolean, source: Block = ShadowFoxBlocks.sealingPlanks) : BlockRainbowWoodSlab(full, source), ISoundSilencer {
//
//    init {
...
//
@Deprecated("1.7.10")
class BlockSealingWoodStairs()
// source: Block = ShadowFoxBlocks.sealingPlanks) : BlockRainbowWoodStairs(source), ISoundSilencer {
//
//    init {
//        setStepSound(Block.soundTypeCloth)
//    }
