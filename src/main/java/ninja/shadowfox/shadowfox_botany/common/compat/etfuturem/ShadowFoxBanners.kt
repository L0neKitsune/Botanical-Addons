package ninja.shadowfox.shadowfox_botany.common.compat.etfuturem

import net.minecraft.item.ItemStack
import net.minecraftforge.common.util.EnumHelper
import ninja.shadowfox.shadowfox_botany.common.item.ShadowFoxItems

object ShadowFoxBanners {

    val coatNames = arrayOf(
            "chile", "france", "japan", "germany",
            "greece", "iceland", "ireland", "israel",
            "jamaica", "singapore", "southafrica", "spain",
            "switzerland", "texas", "ukraine", "unitedstates",
            "alfheim"
    )
    ...
    fun addPattern(clazz: Class<Enum<*>>, name: String, id: String, craftingItem: ItemStack) {
        var changedname = "botanicaladdons_" + name
        var changedid = "ba_" + id
